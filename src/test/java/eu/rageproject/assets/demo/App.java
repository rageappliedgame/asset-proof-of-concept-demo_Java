...
public class App {
	public static void main(String[] args) throws IOException {
		...
		// Check the results for both Loggers differ (one message goes to the
		// console, the other shows as an alert).
		//
		...
		// ! Test if we can re-register without creating new stuff in the
		// register (i.e. get the existing unique id returned).
		//
